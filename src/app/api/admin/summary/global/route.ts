...
export async function GET(request: Request) {
    ...
    try {
        ...
        const summaryData: GlobalSummary = {
            ...
            totalSales: salesStats._sum.totalPrice ? salesStats._sum.totalPrice.toNumber() : 0,
        ...
        return NextResponse.json({ error: 'Failed to fetch global summary data' }, { status: 500 });
    }
}